...
//		SDLRendererWrapper(SDL_Window * window, Uint32 flags = SDL_RENDERER_ACCELERATED);
		SDLRendererWrapper(SDLWindowWrapper & window, Uint32 flags = SDL_RENDERER_ACCELERATED);
		...
		void copy(SDL_Rect dest_rect, SDLTextureWrapper & texture, SDL_Rect texture_rect);

		void copy(SDL_Rect dest_rect, SDLTextureWrapper & texture, SDL_Rect texture_rect, double angle, SDL_RendererFlip flip = SDL_FLIP_NONE);
		void copy(SDL_Rect dest_rect, SDLTextureWrapper & texture, SDL_Rect texture_rect, double angle, SDL_Point center, SDL_RendererFlip flip = SDL_FLIP_NONE);
