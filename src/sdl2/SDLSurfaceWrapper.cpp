...
namespace sdl2 {
//	void SDLSurfaceWrapper::fill_rect(SDL_Surface * surface, Uint8 r, Uint8
//g, Uint8 b) {
//		fill_rect(surface, SDL_MapRGB(surface->format, r, g, b));
//	}
//
//	void SDLSurfaceWrapper::fill_rect(SDL_Surface * surface, Uint8 r, Uint8
//g, Uint8 b, SDL_Rect rect) {
...
SDLSurfaceWrapper::SDLSurfaceWrapper(SDL_Surface * surface)
    : pixels_(), surface_(surface, SDL_FreeSurface) {
    if (!surface_) {
...
//	}
//
//	void SDLSurfaceWrapper::blit_onto(SDL_Rect src_rect, SDL_Surface *
//other) {
//		SDL_BlitSurface(get(), &src_rect, other, NULL);
//	}
//
//	void SDLSurfaceWrapper::blit_onto(SDL_Surface * other, SDL_Rect
//dest_rect) {
//		SDL_BlitSurface(get(), NULL, other, &dest_rect);
//	}
//
//	void SDLSurfaceWrapper::blit_onto(SDL_Rect src_rect, SDL_Surface *
//other, SDL_Rect dest_rect) {
...
//	}
//
//	void SDLSurfaceWrapper::blit_onto(SDL_Rect src_rect, SDLSurfaceWrapper &
//other) {
//		blit_onto(src_rect, other.get());
//	}
//
//	void SDLSurfaceWrapper::blit_onto(SDLSurfaceWrapper & other, SDL_Rect
//dest_rect) {
