...
namespace sdl2 {
	...
	public:
//		static void fill_rect(SDL_Surface * surface, Uint8 r, Uint8 g, Uint8 b);
//		static void fill_rect(SDL_Surface * surface, Uint8 r, Uint8 g, Uint8 b, SDL_Rect rect);
//		static void fill_rect(SDL_Surface * surface, Uint32 color);
//		static void fill_rect(SDL_Surface * surface, Uint32 color, SDL_Rect rect);
...
//		void blit_onto(SDL_Rect src_rect, SDL_Surface * other, SDL_Rect dest_rect);
...
//		void blit_onto(SDL_Rect src_rect, SDLSurfaceWrapper & other, SDL_Rect dest_rect);
//
