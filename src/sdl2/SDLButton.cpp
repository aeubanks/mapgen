...
//
//namespace sdl2 {
//	SDLButton::SDLButton(SDLRendererWrapper & renderer, string file_name, std::array<SDL_Rect, 4> rects) : texture_(renderer, SDLSurfaceWrapper(file_name)), state_(SDLButtonState::Out), rects_(rects) { }
//
